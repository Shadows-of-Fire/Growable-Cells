...
public class ConfigFile {
	...
	public static void syncConfig() { // Gets called from preInit
	    try {
	        ...
	        Property purpurProp = CommonProxy.config.get(Configuration.CATEGORY_GENERAL, // What category will it be saved to, can be any string
	                "extraFromPurpur (RS)", // Property name
	                "true", // Default value
	                "If purpur blocks give extra seeds"); // Comment
	        Property quartzProp = CommonProxy.config.get(Configuration.CATEGORY_GENERAL, // What category will it be saved to, can be any string
