...
public class ModRegistry {
	...
	public static void initRS() {
		cropr1k = new BlockRefinedCellCrop("cropr1k",
				new ItemStack(com.raoulvdberge.refinedstorage.RSItems.STORAGE_DISK, 1, 0));
		cropr4k = new BlockRefinedCellCrop("cropr4k",
				new ItemStack(com.raoulvdberge.refinedstorage.RSItems.STORAGE_DISK, 1, 1));
		cropr16k = new BlockRefinedCellCrop("cropr16k",
				new ItemStack(com.raoulvdberge.refinedstorage.RSItems.STORAGE_DISK, 1, 2));
		cropr64k = new BlockRefinedCellCrop("cropr64k",
				new ItemStack(com.raoulvdberge.refinedstorage.RSItems.STORAGE_DISK, 1, 3));
